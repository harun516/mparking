...
//login
    ...
    Route::post('/proseslogin', 'LoginController@ProsesLogin')->name('login.proses');
    Route::post('/logout', 'LoginController@logout')->name('logout');

//dashboard
    Route::middleware(['checkLogin'])->group(function () {
        Route::get('/dashboard', 'Controller@index')->name('dashboard.index');
        Route::get('/dashboard/get', 'Controller@get')->name('dashboard.get');
        Route::delete('/dashboard/hapus/{kode_parkir}', 'Controller@destroy')->name('transaksi.destroy');
        Route::get('/dashboard/lihat/{kode_parkir}', 'Controller@getKendaraan')->name('transaksi.lihat');
        // user
...
//report - inbound
        ...
        Route::get('/report/inbound', 'ReportController@InboundGet')->name('reportinbound.get');
...
//report - outbound
        ...
        Route::get('/reportout/outbound', 'ReportController@OutboundGet')->name('reportoutbound.get');
// Route::post('/checkout/simpan', 'ReportController@simpanCheckout')->name('checkout.simpan');
