                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="kdpkr"
                                            placeholder="Masukkan barcode kendaraan" required focus>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function simpanData() {
                ...
                $.ajax({
                    url: "{{ route('finishunloading.simpan') }}", // Rute untuk menyimpan atau mengupdate data
                    type: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "kdpkr": kdpkr,
