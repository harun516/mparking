...
@section('content')
                    ...
                    <form id="pengantarform">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pgnid" placeholder="Masukkan pengantaran">
                            </div>
                            <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#pengantarform").submit(function(event) {
            ...
            function simpanData() {
                ...
                $.ajax({
                    url: "{{ route('pengantaran.store') }}", // Gantilah dengan nama route yang sesuai
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "pgnid": pgnid,
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = "{{ route('pengantaran.index') }}";
                        });
                    },
