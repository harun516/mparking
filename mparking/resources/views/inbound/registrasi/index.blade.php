                ...
                <div class="card">
                    ...
                    <form id="registrasimobilform">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="pgnid" class="col-sm-2 col-form-label">Form Pengantaran</label>
                                <div class="col-sm-10">
                                    <select class="form-control select2bs4" id="pgnid" style="width: 100%;"
                                        data-placeholder="Pilih pengantaran">
                                        <option> </option>
                                        @foreach ($pengantarans as $pgn)
                                            <option value="{{ $pgn->pengantaran_id }}">{{ $pgn->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="nrfs" class="col-sm-2 col-form-label">Nomor Referensi Surat Jalan</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="nrfs"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function getbarcode() {
                ...
                $.ajax({
                    url: "{{ route('mobilbarcode.show', ':brcd') }}".replace(':brcd', brcd),
                    type: 'GET',
                    headers: {
            ...
            function simpanData() {
                ...
                $.ajax({
                    url: "{{ route('registrasimobil.simpan') }}", // Rute untuk menyimpan atau mengupdate data
                    type: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "brcd": brcd,
