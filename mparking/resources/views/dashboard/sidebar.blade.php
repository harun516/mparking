...
<body>
    ...
    <aside class="main-sidebar sidebar-light-success elevation-4">
        ...
        <a href="index3.html" class="brand-link bg-success" style="height: 57px; display: flex; align-items: center;">
            <img src="{{ asset('mparking\adminlte\admin-lte\dist\img\logo.png') }}" alt="AdminLTE Logo"
                class="brand-image elevation-3" style="opacity: .8; width: 100px; height: 100px; margin: 0 auto;">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    @if (Auth::check() && Auth::user()->role_id == 'RL-1')
